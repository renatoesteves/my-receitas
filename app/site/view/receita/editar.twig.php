...
{% block title %}Alterar Receita - Receitas {% endblock %}
...
<form action="{{BASE}}receita/alterar/{{receitaId}}" onsubmit="return validar(true);" method="post">
  ...
  <div class="row">
        <div class="col-md-12 mt-3">
            ...
            <input type="text" id="txtLinhaFina" name="txtLinhaFina" class="form-control" placeholder="Descreva a receita"
            minlength="10" maxlength="250" value="{{receita.linhaFina}}" />
        </div> 
